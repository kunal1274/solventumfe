...
import MulesoftLogTableResizing from "./MulesoftLogResizing";

const keywords = ["high", "critical", "urgent", "important", "emergency"];
const TabsMulesoft = () => {
  const [activeTab, setActiveTab] = useState("mulesoft");
  const [firstLevelTab, setFirstLevelTab] = useState("current");
  ...
  return (
    <div>
      <div className="flex space-x-4 mb-4 ml-4">
        ...
        <button
          className={`px-4 py-2 font-semibold ${
            activeTab === "analysisFirstDraft"
              ? "bg-blue-500 text-white"
              : "bg-gray-200"
          } rounded-md`}
          onClick={() => setActiveTab("analysisFirstDraft")}
        >
          Analysis First Draft
        </button>
        <button
          className={`px-4 py-2 font-semibold ${
            activeTab === "analysisSecondDraft" ? "bg-blue-500 text-white" : "bg-gray-200"
          } rounded-md`}
          onClick={() => setActiveTab("analysisSecondDraft")}
        >
        ...
        <>
          <div className="flex flex-start ml-2">
            <div className="flex flex-col space-y-2 p-2">
              <button
                className={`px-4 py-2 font-semibold ${
                  firstLevelTab === "current"
                    ? "bg-indigo-500 text-white"
                    : "bg-gray-200"
                } rounded-md`}
                onClick={() => setFirstLevelTab("current")}
              >
                Current
              </button>
              <button
                className={`px-4 py-2 font-semibold ${
                  firstLevelTab === "currentFirstDraft"
                    ? "bg-indigo-500 text-white"
                    : "bg-gray-200"
                } rounded-md`}
                onClick={() => setFirstLevelTab("currentFirstDraft")}
              >
                Current First Draft
              </button>
              <button
                className={`px-4 py-2 font-semibold ${
                  firstLevelTab === "currentSecondDraft"
                    ? "bg-indigo-500 text-white"
                    : "bg-gray-200"
                } rounded-md`}
                onClick={() => setFirstLevelTab("currentSecondDraft")}
              >
                  ...
                  <div>
                    ...
                    {loading && (
                      <div className="text-center my-4">
                        ...
                        <p>
                          Loading Current Mulesoft data, please wait...
                          {loadingProgress}%
                        </p>
                        {/* )} */}
                      </div>
              ...
              <>
                <div className="flex flex-col w-[80%]">
                  <div className="mx-2 my-2">
                    ...
                    <div>
                      <h2 className="text-md font-semibold mb-4">
                       Current First Draft Upload Excel File
                      </h2>
                      <input
                        type="file"
                        accept=".xlsx, .xls"
                  ...
                  <div>
                    ...
                    {loading && (
                      <div className="text-center my-4">
                        ...
                        <p>
                          Loading Current First Draft Data, please wait...
                          {loadingProgress}%
                        </p>
                        {/* )} */}
                      </div>
                    ...
                    {!loading  &&  data[firstLevelTab].length > 0 && (
                      <div className="flex flex-col justify-start mt-4">
                        <h3 className="text-md font-semibold mb-3">
                          Current First Draft Excel Data:
                        </h3>
                        <List
                          height={400}
                          itemCount={data[firstLevelTab].length}
      ...
      {activeTab === "analysisFirstDraft" && (
        <>
          <div className="ml-4">
            <p> This is Analysis First Draft tab</p>
          </div>
        </>
      )}

      {activeTab === "analysisSecondDraft" && (
        <>
          <div className="ml-4">
            <p>Analysis Second Draft Tab</p>
          </div>
        </>
      )}
    </div>
